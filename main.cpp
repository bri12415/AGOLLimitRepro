...
int main(int argc, char *argv[])
{
  ...
  qmlRegisterType<MapQuickView>("Esri.TokenErrorRepro", 1, 0, "MapView");

  // Register the TokenErrorRepro (QQuickItem) for QML
  qmlRegisterType<TokenErrorRepro>("Esri.TokenErrorRepro", 1, 0, "TokenErrorRepro");
